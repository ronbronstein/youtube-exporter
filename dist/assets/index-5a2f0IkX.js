...
class App extends BaseComponent {
  ...
  onMount() {
    ...
    this.components.messagePanel = GlobalMessages.init(
      ...
      { position: "banner", maxMessages: 1, autoHideDelay: { success: 3e3, error: 8e3, warning: 5e3, info: 4e3 } }
    );
...
async function runIntegrationTests() {
  try {
    const { default: IntegrationTest } = await __vitePreload(async () => {
      const { default: IntegrationTest2 } = await import("./integration-test-D0Q6Jlft.js");
