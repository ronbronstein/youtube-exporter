...
class YouTubeApiService {
  ...
  async getAllChannelVideos(uploadsPlaylistId, progressCallback = null) {
    ...
    const maxPages = this.isDemoMode ? 2 : 100;
    ...
    do {
      ...
      if (data.items && data.items.length > 0) {
        ...
        const videosToAdd = this.isDemoMode ? videos.slice(0, Math.max(0, videoLimit - videosCollected)) : videos;
...
class App extends BaseComponent {
    ...
    return `
            <div class="mode-selector-minimal">
                ...
                <div class="mode-description">
                    ${currentMode === "demo" ? "Demo mode: Built-in API key, limited to 100 videos" : "Full mode: Use your own API key, unlimited videos"}
                </div>
            </div>
        `;
  }
            ...
            <div class="search-section-minimal">
                ...
                <div class="search-action-large">
                    ...
                    <div class="search-status">
                        ${this.appState.currentEnvironment === "demo" ? "Demo: 100 video limit" : this.appState.currentEnvironment === "live" ? "Full: Unlimited videos" : "Development mode"}
                    </div>
                </div>
            </div>
        `;
  ...
  async handleAnalyzeChannel() {
    ...
    try {
      ...
      if (keywords) {
        ...
        const channelName = ((_d = this.appState.channelData) == null ? void 0 : _d.channelTitle) || ((_f = (_e = this.appState.channelData) == null ? void 0 : _e.snippet) == null ? void 0 : _f.title) || "Unknown Channel";
        if (this.components.results) {
  ...
  setupModeSpecificListeners() {
    ...
    if (channelInput) {
      this.addListener(channelInput, "input", this.handleChannelInput.bind(this));
      this.addListener(channelInput, "keydown", (e) => {
        if (e.key === "Enter" && !(searchBtn == null ? void 0 : searchBtn.disabled)) {
          this.handleAnalyzeChannel();
        }
      });
...
async function runIntegrationTests() {
  try {
    const { default: IntegrationTest } = await __vitePreload(async () => {
      const { default: IntegrationTest2 } = await import("./integration-test-blizeNJG.js");
