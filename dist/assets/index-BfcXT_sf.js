...
class App extends BaseComponent {
            ...
            <div class="search-section">
                ...
                <div class="search-action">
                    ...
                    <div class="search-help">
                        ${this.appState.currentEnvironment === "demo" ? "Demo mode: 100 video limit, built-in API key" : this.appState.currentEnvironment === "live" ? "Live mode: Full access with your API key" : "Development mode"}
                    </div>
                </div>
            </div>
        `;
  ...
  updateAnalyzeButtonState() {
    ...
    searchBtn.disabled = !hasApiKey || !hasChannel || this.appState.isLoading;
  }
  ...
  async initializeDemoMode() {
    try {
      const demoApiKey = define_process_env_default.VITE_DEMO_API_KEY || "AIzaSyDemo_EnableButton_ForTestingPurposes";
...
async function runIntegrationTests() {
  try {
    const { default: IntegrationTest } = await __vitePreload(async () => {
      const { default: IntegrationTest2 } = await import("./integration-test-CZbxfSQG.js");
